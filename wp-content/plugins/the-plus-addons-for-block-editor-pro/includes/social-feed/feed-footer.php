    ...
    echo '<div class="tpgb-sf-footer">';
            ...
            if(isset($Fblikes)){
                echo '<span class="tpgb-btn-like">';
                    if(!empty($showFooterIn) && $style == "style-2" ){
                        echo esc_html__("Like ","tpgbp");
                    }else{
                        echo '<img src="'.esc_url($likeImg).'" alt="'.esc_attr__('Like','tpgbp').'"/>';
                        echo '<img src="'.esc_url($ReactionImg).'" alt="'.esc_attr__('Reaction','tpgbp').'"/>';
                    }
                    echo tpgbp_number_short($Fblikes);
                echo '</span>';
            }
            if(isset($comment)){
                echo '<span class="tpgb-btn-comment">';
                    if(!empty($showFooterIn) && $style == "style-2" ){
                        echo esc_html__('comment ','tpgbp');
                    }else{
        ...
        if($selectFeed == 'Twitter'){
            if(isset($TwRT)){
                echo '<span class="button-comment">';
                    echo '<a href="'.esc_url($TwRetweetURL).'" aria-label="'.esc_attr__('Retweet','tpgbp').'">';
                        if(!empty($showFooterIn) && $style == "style-2" ){
                            echo esc_html__('Retweet ','tpgbp');
                        }else{
                            echo '<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="retweet-alt" class="svg-inline--fa fa-retweet-alt fa-w-20 tpgb-svg" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path fill="currentColor" d="M392.402 383.598C404.359 395.555 395.891 416 378.981 416H120c-13.255 0-24-10.745-24-24V192H48c-21.361 0-32.045-25.895-16.971-40.971l80-80c9.373-9.372 24.568-9.372 33.941 0l80 80C240.074 166.134 229.319 192 208 192h-48v160h202.056c7.82 0 14.874 4.783 17.675 12.084a55.865 55.865 0 0 0 12.671 19.514zM592 320h-48V120c0-13.255-10.745-24-24-24H261.019c-16.91 0-25.378 20.445-13.421 32.402a55.865 55.865 0 0 1 12.671 19.514c2.801 7.302 9.855 12.084 17.675 12.084H480v160h-48c-21.313 0-32.08 25.861-16.971 40.971l80 80c9.374 9.372 24.568 9.372 33.941 0l80-80C624.041 345.9 613.368 320 592 320z"></path></svg> ';
                        } 
                            echo wp_kses_post($TwRT);
                    echo '</a>';
                echo '</span>';
            }
            if(isset($TWLike)){
                echo '<span class="button-comment">';
                    echo '<a href="'.esc_url($TwlikeURL).'" aria-label="'.esc_attr__('Like','tpgbp').'">';
                        if(!empty($showFooterIn) && $style == "style-2" ){
                            echo esc_html__('Like ','tpgbp');
                        }else{
                            echo '<svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="heart" class="svg-inline--fa fa-heart fa-w-16 tpgb-svg" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M458.4 64.3C400.6 15.7 311.3 23 256 79.3 200.7 23 111.4 15.6 53.6 64.3-21.6 127.6-10.6 230.8 43 285.5l175.4 178.7c10 10.2 23.4 15.9 37.6 15.9 14.3 0 27.6-5.6 37.6-15.8L469 285.6c53.5-54.7 64.7-157.9-10.6-221.3zm-23.6 187.5L259.4 430.5c-2.4 2.4-4.4 2.4-6.8 0L77.2 251.8c-36.5-37.2-43.9-107.6 7.3-150.7 38.9-32.7 98.9-27.8 136.5 10.5l35 35.7 35-35.7c37.8-38.5 97.8-43.2 136.5-10.6 51.1 43.1 43.5 113.9 7.3 150.8z"></path></svg> '; 
                        } 
                            echo wp_kses_post($TWLike);
                    echo '</a>';
                echo '</span>';
            }
        }
        ...
        if($selectFeed == 'Youtube'){ 
            if(isset($view)){
                echo '<span class="button-comment">';
                    if(!empty($showFooterIn) && $style == "style-2" ){
                        echo esc_html__("view ","tpgbp");
                    }else{
                        echo '<svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="eye-slash" class="svg-inline--fa fa-eye-slash fa-w-20 tpgb-svg" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path fill="currentColor" d="M634 471L36 3.51A16 16 0 0 0 13.51 6l-10 12.49A16 16 0 0 0 6 41l598 467.49a16 16 0 0 0 22.49-2.49l10-12.49A16 16 0 0 0 634 471zM296.79 146.47l134.79 105.38C429.36 191.91 380.48 144 320 144a112.26 112.26 0 0 0-23.21 2.47zm46.42 219.07L208.42 260.16C210.65 320.09 259.53 368 320 368a113 113 0 0 0 23.21-2.46zM320 112c98.65 0 189.09 55 237.93 144a285.53 285.53 0 0 1-44 60.2l37.74 29.5a333.7 333.7 0 0 0 52.9-75.11 32.35 32.35 0 0 0 0-29.19C550.29 135.59 442.93 64 320 64c-36.7 0-71.71 7-104.63 18.81l46.41 36.29c18.94-4.3 38.34-7.1 58.22-7.1zm0 288c-98.65 0-189.08-55-237.93-144a285.47 285.47 0 0 1 44.05-60.19l-37.74-29.5a333.6 333.6 0 0 0-52.89 75.1 32.35 32.35 0 0 0 0 29.19C89.72 376.41 197.08 448 320 448c36.7 0 71.71-7.05 104.63-18.81l-46.41-36.28C359.28 397.2 339.89 400 320 400z"></path></svg> ';
