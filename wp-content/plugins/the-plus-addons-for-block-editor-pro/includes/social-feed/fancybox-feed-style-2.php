...
<div class="tpgb-block-<?php echo esc_attr($block_id); ?> fancybox-si fancy-<?php echo esc_attr($FancyStyle); ?>" id="Fancy-<?php echo esc_attr($PopupSylNum); ?>" data-FancyFeedType="<?php echo $selectFeed ?>" >
    ...
    <div class="fancy-fcb-flax d-flex flex-row">
        <div class="tpgb-fcb-img" >
            <?php include TPGBP_INCLUDES_URL."social-feed/fancybox-feed-post.php"; ?>
        </div>
        <div class="tpgb-fcb-contant">
            <?php 
                include TPGBP_INCLUDES_URL."social-feed/fancybox-header.php"; 
                ...
                echo '<div class="tpgb-fcb-footer">';
                        ...
                        echo '<div class="tpgb-btn-viewpost">
                                <a href="'.esc_url($UserLink).'" target="_blank" rel="noopener noreferrer" aria-label="'.esc_attr__('View Post','tpgbp').'">'.esc_html__("View post","tpgbp").'</a>
                            </div>'; 
                echo '</div>';
            ?>
        </div>
...
<?php include TPGBP_INCLUDES_URL."social-feed/popup-type.php"; ?>