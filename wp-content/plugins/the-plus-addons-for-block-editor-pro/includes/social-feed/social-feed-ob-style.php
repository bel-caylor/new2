...
if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
	...
	$Iconlogo = '<div class="tpgb-sf-logo">
					<a href="'.esc_url($videoURL).'" class="tpgb-sf-logo-link" target="_blank" rel="noopener noreferrer" aria-label="'.esc_attr__('Post URL','tpgbp').'">
    		...
    		echo '<div class="tpgb-sf-usercontact">';
    			...
    			if(!empty($CreatedTime)){
    				echo '<div class="tpgb-sf-time">
							<a href="'.esc_url($videoURL).'" target="_blank" rel="noopener noreferrer" alt="'.esc_attr__('Post URL','tpgbp').'">'.wp_kses_post($CreatedTime).'</a></div>';
    			}   
    		echo '</div>';
