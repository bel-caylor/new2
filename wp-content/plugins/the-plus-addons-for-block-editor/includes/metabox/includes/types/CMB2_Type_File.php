...
class CMB2_Type_File extends CMB2_Type_File_Base {
	...
	public function get_file_preview_output() {
		...
		if ( $this->args['id_value'] ) {
			...
			$image = '<img style="max-width: ' . absint( $this->args['img_size_data']['width'] ) . 'px; width: 100%;" src="' . esc_url( $this->args['value'] ) . '" class="cmb-file-field-image" alt="'.esc_attr__('image','tpgb').'" />';
		}
