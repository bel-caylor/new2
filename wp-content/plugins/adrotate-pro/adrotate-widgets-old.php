...
class ajdg_bnnrwidgets extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array( 
			...
			'description' => 'Please use the new AdRotate Advert widget instead.',
		);
		parent::__construct( 'ajdg_bnnrwidgets', 'AdRotate Advert (Depreciated)', $widget_ops );
	}
...
class ajdg_grpwidgets extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array( 
			...
			'description' => 'Please use the new AdRotate Group widget instead.',
		);
		parent::__construct( 'ajdg_grpwidgets', 'AdRotate Group (Depreciated)', $widget_ops );
	}
