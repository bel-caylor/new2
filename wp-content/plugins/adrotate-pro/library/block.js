...
registerBlockType('adrotate/advert', {
	title: __('AdRotate Advert', 'adrotate-pro'), 
	icon: 'editor-code',
	category: 'custom-adrotate',
	description: __('Show a single advert by entering an advert ID.', 'adrotate-pro'),
	...
	edit: function( props ) {
		...
		return el('div', { 
			...
			}, __('You can find the advert ID in Manage Adverts. Any special markup, code or layout styles can be applied in the advert itself or by placing the advert in a group.', 'adrotate-pro')),
		);
	},
...
registerBlockType('adrotate/group', {
    title: __('AdRotate Group', 'adrotate-pro'), 
    icon: 'editor-code',
    category: 'custom-adrotate',
    description: __('Show a group of adverts by entering a group ID.', 'adrotate-pro'),
    ...
    edit: function( props ) {
		...
		return el('div', { 
			...
			el('div', {
				className: 'components-placeholder__label',
				style: { 'font-size': '18pt', 'font-weight': '400' },
			}, __('AdRotate Group', 'adrotate-pro')),
			el('label', {
				className: 'components-placeholder__instructions group-' + props.attributes.group_id,
			}, __('Enter a group ID (numbers only):', 'adrotate-pro')),
			el('input', {
			...
			el('div', {
				className: 'components-placeholder__instructions group-' + props.attributes.group_id,
				style: { 'font-size': '70%', 'font-style': 'italic' },
			}, __('You can find the group ID in Manage Groups. Any special markup, code or layout styles can be applied in the group wrapper when editing the group.', 'adrotate-pro')),
		);
    },
