 ...
 * @category class
 */
class Kadence_Blocks_Pro_Videopopup_Block extends Kadence_Blocks_Pro_Abstract_Block {
	...
	public function register_scripts() {
		...
		wp_register_style( 'kadence-glightbox', KBP_URL . 'includes/assets/css/kb-glightbox.min.css', array(), KBP_VERSION );
		wp_register_script( 'kadence-glightbox', KBP_URL . 'includes/assets/js/glightbox.min.js', array(), KBP_VERSION, true );
		wp_register_script( 'kadence-blocks-pro-glight-video-init', KBP_URL . 'includes/assets/js/kb-glight-video-pop-init.min.js', array( 'kadence-glightbox' ), KBP_VERSION, true );

		$pop_video_array = array(
			'plyr_js'          => KBP_URL . 'includes/assets/js/plyr.min.js',
			'plyr_css'         => KBP_URL . 'includes/assets/css/plyr.min.css',
		);
		wp_localize_script( 'kadence-blocks-pro-glight-video-init', 'kadence_pro_video_pop', $pop_video_array );	}
}

Kadence_Blocks_Pro_Videopopup_Block::get_instance();
