...
class Kadence_Blocks_Pro_Filter_Search_Block extends Kadence_Blocks_Query_Children_Block {
	...
	public function build_html( $attributes, $unique_id, $content, $block_instance ) {
		...
		return sprintf(
			'<div class="kadence-query-filter wp-block-kadence-query-filter-search wp-block-kadence-query-filter-search%s" %s><fieldset class="kadence-filter-wrap">%s%s</fieldset></div>',
			$unique_id,
