...
class Kadence_Blocks_Pro_Filter_Buttons_Block extends Kadence_Blocks_Query_Children_Block {
	...
	public function build_css( $attributes, $css, $unique_id, $unique_style_id ) {
		...
		$css->render_measure_output( $attributes, 'borderHoverRadiusButton', 'border-radius' );
		...
		$css->render_measure_output( $attributes, 'borderActiveRadiusButton', 'border-radius' );
	...
	public function build_html( $attributes, $unique_id, $content, $block_instance ) {
		...
		return sprintf(
			'<div class="wp-block-kadence-query-filter-buttons%s %s" %s><fieldset class="kadence-filter-wrap">%s<div class="buttons-options">%s</div></fieldset></div>',
			$unique_id,
			$classes_str,
