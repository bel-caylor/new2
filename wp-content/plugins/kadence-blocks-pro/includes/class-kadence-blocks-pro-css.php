...
class Kadence_Blocks_Pro_CSS {
	...
	public function frontend_block_css() {
		if ( ! empty( self::$styles ) ) {
			...
			if ( ! empty( $output ) ) {
				wp_register_style( 'kadence_blocks_pro_css', false );
				wp_enqueue_style( 'kadence_blocks_pro_css' );
				wp_add_inline_style( 'kadence_blocks_pro_css', $output );
			}
			if ( ! empty( $custom_output ) ) {
				wp_register_style( 'kadence_blocks_pro_custom_css', false );
				wp_enqueue_style( 'kadence_blocks_pro_custom_css' );
				wp_add_inline_style( 'kadence_blocks_pro_custom_css', $custom_output );
			}
		}
	}
	/**
	...
	/**
	 * Generates the responsive range output. (for array based responsive attribute)
	 *
	 * @param array  $attributes an array of attributes.
	 * @param string $name an string of the attribute name.
...
Kadence_Blocks_Pro_CSS::get_instance();
